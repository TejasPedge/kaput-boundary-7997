...
export const BodyThree = () => {
  return (
    <>
      <Flex mt={"40px"} gap={5} marginX={"80px"}>
      ...
      >
        ...
        <Box textAlign={"center"}>
          <Image
            borderRadius={"5px"}
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTAsXhhhXtmoJujEd2zIbiCRIju_5cDxrij1w&usqp=CAU"
          />
          <Text pt={3}>Shoes</Text>
        </Box>
      </Grid>
    </>
  );
