...
const PaymentDetailCard = ({ total, finalPrice }) => {
  ...
  return (
    <Box>
      <Text fontWeight={700} fontSize={"10"} color="#535766">
        COUPONS
      </Text>
      ...
      <HStack mt="10px" justify={"space-between"}>
        <HStack>
          <FiTag />
          <Text fontWeight={650} color="#282c3f" fontSize="12">
            Apply Coupons
          </Text>
        </HStack>
        <Button
      ...
      <HStack mt="10px" ml="25px" pb="10px">
        <Text fontWeight={650} fontSize={12} cursor={"pointer"} color="#f63a3a">
          Login
        </Text>
        <Text fontSize={12} cursor={"pointer"} color="gray.700">
      ...
      <Stack>
        ...
        <Flex mt="10px" justify="space-between">
          <Text color="#282c3f" fontSize="12">
            Convinience Fee{" "}
            <Text fontWeight={"700"} color="#f63a3a" as="span" ml="5px">
              Know More
            </Text>
          </Text>
      ...
      <Flex mt="10px" justify="space-between">
        <Text fontWeight={"700"} color="#282c3f" fontSize="12.5">
          Total Amount
        </Text>
        <Text fontWeight={"700"} color="#282c3f" fontSize="12.5">
          Rs. {finalPrice}
