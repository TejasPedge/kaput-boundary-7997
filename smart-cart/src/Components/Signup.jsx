...
//  console.log(logdata)
 ...
 const handleSubmit=(e)=>{
    ...
    return (
        <>
     <Box p = '10px' mb = '60px' position = 'relative' top="1px" backgroundSize={"Cover"}    backgroundImage={isDark&&"url('https://images.pexels.com/photos/1647962/pexels-photo-1647962.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')"} >
...
<Box p = '30px' color = 'white' backgroundImage={isDark==false &&"url('https://images.pexels.com/photos/9117243/pexels-photo-9117243.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')"}                  bgRepeat={"no-repeat"} className={styles.box2} border="1px solid teal" margin="auto" marginTop={"20px"} width={{base:"90%",md:"40%",lg:"30%",xl:"30%","2xl":"30%"}}  >
    <SignLogo/>
...
<Button className={styles.inputboxes} width="80%" margin="auto" display={"block"} bg="blue.200" mt="20px"  type="submit">SIGN UP</Button>
        <Heading mt = '10px' fontWeight={"bold"} fontSize="15px" >Already Have an Account?</Heading><br/>
        <Button ml = '20px' className={styles.buttons}  marginTop="15px" color="blue"><Link  to="/login">LOGIN</Link></Button>
</form>
</Box>
